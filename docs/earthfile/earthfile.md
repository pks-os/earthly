...
Earthly provides officially supported images such as `earthly/dind:alpine-3.20-docker-26.1.3-r2` and `earthly/dind:ubuntu-23.04-docker-25.0.2-1` to be used together with `WITH DOCKER`.
{% endhint %}
